...
return {
	...
	["yinghun"] = "英魂",
	[":yinghun"] = "开始阶段开始时，若你已受伤，你可以选择一名其他角色并选择一项：令其摸一张牌，然后弃置X张牌，或令其摸X张牌，然后弃置一张牌。（X为你已损失的体力值）",
	...
	["dimeng"] = "缔盟",
	[":dimeng"] = "<font color=\"green\"><b>阶段技。</b></font>你可以选择两名其他角色并弃置等于其手牌数差数量的牌：若如此做，这两名角色交换他们的手牌。",
	...
	["benghuai:maxhp"] = "体力上限",
	["baonue"] = "暴虐",
	[":baonue"] = "<font color=\"orange\"><b>主公技。</b></font>其他群雄角色造成伤害后，该角色可以进行一次判定：若判定结果为♠，你回复1点体力。",
