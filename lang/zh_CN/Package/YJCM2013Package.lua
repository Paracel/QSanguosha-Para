...
return {
	...
	["chengxiang"] = "称象",
	[":chengxiang"] = "每当你受到一次伤害后，你可以展示所有手牌：若其点数和小于13，你可以摸一张牌，且可以再次发动“称象”。",
	["renxin"] = "仁心",
	...
	["junxing"] = "峻刑",
	[":junxing"] = "<font color=\"green\"><b>阶段技。</b></font>出牌阶段，你可以弃置至少一张手牌并选择一名其他角色：若如此做，该角色须弃置一张与你弃置的牌类型均不同的手牌，否则将武将牌翻面并摸X张牌。（X为你弃置的牌的数量）",
	["@junxing-discard"] = "请弃置一张与“峻刑”弃牌类型均不同的手牌",
	["yuce"] = "御策",
	[":yuce"] = "每当你受到一次伤害后，你可以展示一张手牌：若如此做，伤害来源须弃置一张与该牌类型不同的手牌，否则你回复1点体力。",
	["@yuce-show"] = "你可以发动“御策”展示一张手牌",
	["@yuce-discard"] = "请弃置一张 %arg 或 %arg2",
	...
	["qiaoshui"] = "巧说",
	[":qiaoshui"] = "<font color=\"green\"><b>阶段技。</b></font>出牌阶段，你可以与一名其他角色拼点：若你赢，本回合你使用的下一张基本牌或非延时类锦囊牌可以增加一个额外目标（无距离限制）或减少一个目标（若原目标数大于1）；若你没赢，你不能使用锦囊牌，直到回合结束。",
	["qiaoshui:add"] = "增加一个目标",
	...
	["xiansi"] = "陷嗣",
	[":xiansi"] = "回合开始阶段开始时，你可以将一至两名其他角色的各一张牌置于你的武将牌上，称为“逆”。每当一名其他角色需要对你使用【杀】时，该角色可以将两张“逆”置入弃牌堆，视为对你使用一张【杀】。",
	...
	["duodao"] = "夺刀",
	[":duodao"] = "<font color=\"green\"><b>阶段技。</b></font>出牌阶段，你可以与一名装备区内有武器牌的其他角色拼点：若你赢，你获得其装备区的武器牌；若你没赢，你不能使用【杀】，直到回合结束。",
	["anjian"] = "暗箭",
	...
	["illustrator:yufan"] = "L",
	["zongxuan"] = "纵玄",
	[":zongxuan"] = "当你的牌因弃置而置入弃牌堆时，你可以将其中任意数量的牌以任意顺序置于牌堆顶。",
	["@zongxuan-put"] = "你可以将因弃置而置入弃牌堆的牌以任意顺序置于牌堆顶",
	["~zongxuan"] = "选择任意数量的牌→点击确定（这些牌将以与你点击顺序相反的顺序置于牌堆顶）",
	["zhiyan"] = "直言",
	[":zhiyan"] = "回合结束阶段开始时，你可以令一名角色摸一张牌并展示之：若此牌为装备牌，该角色回复1点体力，然后使用之。",
	...
	["juece"] = "绝策",
	[":juece"] = "你的回合内，一名角色失去最后的手牌后，你可以对其造成1点伤害。",
	["mieji"] = "灭计",
	[":mieji"] = "<font color=\"blue\"><b>锁定技。</b></font>你使用黑色非延时类锦囊牌目标数上限至少为2。",
	["~mieji"] = "选择【借刀杀人】的目标角色→选择【杀】的目标角色→点击确定",
	["fencheng"] = "焚城",
	[":fencheng"] = "<font color=\"red\"><b>限定技。</b></font>出牌阶段，你可以令所有其他角色弃置X张手牌，否则你对该角色造成1点火焰伤害。（X为该角色装备区牌的数量且至少为1）",
	["@burn"] = "焚城",
}