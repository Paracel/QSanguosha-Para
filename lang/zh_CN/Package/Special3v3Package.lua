...
return {
	...
	["&vs_xiahoudun"] = "夏侯惇",
	["vsganglie"] = "刚烈",
	[":vsganglie"] = "每当你受到一次伤害后，你可以选择一名对方角色并进行一次判定：若判定结果不为<font color=\"red\">♥</font>，则该角色选择一项：弃置两张手牌，或受到你造成的1点伤害。",
					--[[身份局：每当你受到一次伤害后，你可以选择一名其他角色并进行一次判定：若判定结果不为♥，则该角色选择一项：弃置两张手牌，或受到你造成的1点伤害。]]
	...
	["&vs_lvbu"] = "吕布",
	["zhanshen"] = "战神",
	[":zhanshen"] = "<font color=\"purple\"><b>觉醒技。</b></font>开始阶段开始时，若你已受伤且有己方角色已死亡，你失去1点体力上限，弃置装备区的武器牌，然后获得技能“马术”和“神戟”。",
					--[[身份局：觉醒技。一名其他角色死亡时，可以令你获得一枚“战”标记。开始阶段开始时，若你已受伤且拥有“战”标记，你失去1点体力上限，弃置装备区的武器牌，然后获得技能“马术”和“神戟”。]]
	...
	[":zhenwei"] = "<font color=\"blue\"><b>锁定技。</b></font>对方角色到其他己方角色的距离+1。",
					--[[身份局：回合结束时，你可以令至多X名其他角色获得一枚“卫”标记，直到你下回合结束。除你和拥有“卫”标记的角色到拥有“卫”标记的角色距离+1（X为本场游戏人数的一半减1，向下取整）。]]
	["@defense"] = "卫",
	["@zhenwei"] = "你可以发动“镇卫”",
