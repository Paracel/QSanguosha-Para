...
return {
	...
	["guding_blade"] = "古锭刀",
	[":guding_blade"] = "装备牌·武器<br />攻击范围：２<br />武器特效：<font color=\"blue\"><b>锁定技。</b></font>每当你使用【杀】对目标角色造成伤害时，若该角色没有手牌，此伤害+1",
	...
	["silver_lion"] = "白银狮子",
	[":silver_lion"] = "装备牌·防具<br />防具效果：<font color=\"blue\"><b>锁定技。</b></font>每当你受到伤害时，若该伤害多于1点，防止多余的伤害。每当你失去装备区里的【白银狮子】后，你回复1点体力",
	...
	["iron_chain"] = "铁索连环",
	[":iron_chain"] = "锦囊牌<br />出牌时机：出牌阶段。<br />使用目标：一至两名角色<br />作用效果：横置或重置目标角色的武将牌，被横置的角色处于“连环状态” <br />重铸：将该牌置入弃牌堆，然后摸一张牌",

	["supply_shortage"] = "兵粮寸断",
	[":supply_shortage"] = "延时锦囊牌<br />出牌时机：出牌阶段<br />使用目标：距离1的一名其他角色。<br />作用效果：将【兵粮寸断】置于目标角色判定区内。目标角色下个判定阶段进行判定；若结果不为♣，则跳过其摸牌阶段。然后将【兵粮寸断】置入弃牌堆。",
