...
return {
	...
	["luoying"] = "落英",
	[":luoying"] = "其他角色的牌因判定或弃置而置入弃牌堆时，你可以获得其中任意数量的梅花牌。",
	["jiushi"] = "酒诗",
	...
	["illustrator:masu"] = "张帅",
	["xinzhan"] = "心战",
	[":xinzhan"] = "阶段技。若你的手牌数大于你的体力上限，你可以观看牌堆顶的三张牌，展示并获得其中任意数量的红桃牌，然后将其余的牌以任意顺序置于牌堆顶。",
	["huilei"] = "挥泪",
	[":huilei"] = "锁定技。杀死你的角色弃置其所有牌。",
	...
	["mingce"] = "明策",
	[":mingce"] = "阶段技。你可以将一张装备牌或【杀】交给一名其他角色：若如此做，该角色可以视为对其攻击范围内由你选择的另一名角色使用一张【杀】，否则其摸一张牌。",
	["zhichi"] = "智迟",
	...
	["zili"] = "自立",
	[":zili"] = "觉醒技。准备阶段开始时，若“权”大于或等于三张，你失去1点体力上限，摸两张牌或回复1点体力，然后获得“排异”（阶段技。你可以将一张“权”置入弃牌堆并选择一名角色：若如此做，该角色摸两张牌。若该角色手牌多于你，你对其造成1点伤害）。",
	...
	["paiyi"] = "排异",
	[":paiyi"] = "阶段技。你可以将一张“权”置入弃牌堆并选择一名角色：若如此做，该角色摸两张牌。若该角色手牌多于你，你对其造成1点伤害。",
}
