...
return {
	...
	["nosfanjian"] = "反间",
	[":nosfanjian"] = "阶段技。你可以令一名其他角色选择一种花色，然后正面朝上获得你的一张手牌。若此牌花色与该角色所选花色不同，你对其造成1点伤害。",
	...
	["&nos_yuji"] = "于吉",
	["nosguhuo"] = "蛊惑",
	[":nosguhuo"] = "你可以扣置一张手牌当做一张基本牌或非延时锦囊牌使用或打出，体力值大于0的其他角色选择是否质疑，然后你展示此牌：若无角色质疑，此牌按你所述类型结算；若有角色质疑：若此牌为真，质疑角色各失去1点体力；若此牌为假，质疑角色各摸一张牌；且若此牌为红桃且为真，则依旧进行结算，否则将其置入弃牌堆。",
