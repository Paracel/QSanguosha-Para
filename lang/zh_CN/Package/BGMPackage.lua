...
return {
	...
	["mouduan"] = "谋断",
	[":mouduan"] = "游戏开始时，你获得一枚“文/武”标记且“武”朝上。若你的手牌数小于或等于2，你的标记为“文”朝上。其他角色的回合开始时，若“文”朝上，你可以弃置一张牌：若如此做，你将标记翻至“武”朝上。若“武”朝上，你拥有技能“谦逊”和“激昂”；若“文”朝上，你拥有技能“英姿”和“克己”。",
	...
	["huangen"] = "皇恩",
	[":huangen"] = "每当一张锦囊牌指定了至少两名目标后，你可以令至多X名角色各摸一张牌，然后该锦囊牌对这些角色无效。（X为你当前的体力值）",
	["hantong"] = "汉统",
