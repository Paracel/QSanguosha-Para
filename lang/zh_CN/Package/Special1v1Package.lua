...
return {
	...
	[":koftuxi_p"] = "摸牌阶段，你可以少摸一张牌并选择一名手牌数大于你的手牌数的其他角色：若如此做，你获得该角色一张手牌。",
	...
	[":mouzhu_p"] = "<font color=\"green\"><b>阶段技。</b></font>你可以令一名有手牌的其他角色交给你一张手牌：若你的手牌数大于该角色的手牌数，该角色选择一项：视为对你使用一张无距离限制的【杀】，或视为对你使用一张【决斗】。",
