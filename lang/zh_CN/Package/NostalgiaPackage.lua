...
return {
	...
	["&nos_zhouyu"] = "周瑜",
	["nosfanjian"] = "反间",
	[":nosfanjian"] = "<font color=\"green\"><b>阶段技。</b></font>你可以令一名其他角色选择一种花色，然后展示你的一张手牌。若该牌花色与该角色所选花色不同，你对其造成1点伤害。伤害结算完毕后该角色获得该牌。",
	...
	["&nos_zhoutai"] = "周泰",
	["nosbuqu"] = "不屈",
	[":nosbuqu"] = "每当你扣减1点体力后，若你的体力值为0或更低，你可以将牌堆顶的一张牌置于你的武将牌上。当且仅当出现同点数的“不屈牌”，你进入濒死状态。每当你回复1点体力后，你将一张“不屈牌”置入弃牌堆。",
	...
	["nosxuanfeng"] = "旋风",
	[":nosxuanfeng"] = "每当你失去一次装备区里的装备牌后，你可以选择一项：视为使用一张无距离限制的【杀】，或对距离1的一名角色造成1点伤害",
	...
	["nosqianxi"] = "潜袭",
	[":nosqianxi"] = "每当你使用【杀】对距离1的目标角色造成伤害时，你可以进行判定：若结果不为<font color=\"red\">♥</font>，防止此伤害，该角色失去1点体力上限。",
	...
	["nosfuhun"] = "父魂",
	[":nosfuhun"] = "摸牌阶段，你可以放弃摸牌，展示牌堆顶的两张牌并获得之：若展示的牌不为同一颜色，你拥有“武圣”、“咆哮”，直到回合结束。",
	...
	["nospower"] = "权",
	["nosbaijiang"] = "拜将",
	[":nosbaijiang"] = "<font color=\"purple\"><b>觉醒技。</b></font>准备阶段开始时，若你的装备区的装备牌大于或等于三张，你增加1点体力上限，回复1点体力，然后失去“权计”和“争功”并获得“野心”（每当你造成或受到伤害后，你可以将牌堆顶的一张牌置于武将牌上，称为“权”。<font color=\"green\"><b>阶段技。</b></font>你可以获得任意数量的“权”，然后将等数量的手牌加入“权”）。",
	...
	["noszili"] = "自立",
	[":noszili"] = "<font color=\"purple\"><b>觉醒技。</b></font>准备阶段开始时，若你的“权”大于或等于四张，你失去1点体力上限，然后获得“排异”（结束阶段开始时，你可以将一张“权”移动到一个合理的区域。若不是你的区域，你摸一张牌）。",
