...
return {
	...
	[":suzi"] = "每当已死亡的对手的牌因弃置而置入弃牌堆前，你可以获得之。",
				--[[身份局：已死亡的其他角色的牌因弃置而置入弃牌堆前，你可以获得之。]]
	...
	[":cangji"] = "你死亡时，你可以将装备区的所有装备牌移出游戏：若如此做，你的下个武将登场时，将这些牌置于装备区。",
					--[[身份局：你死亡时，你可以将你装备区的任意数量的装备牌以任意分配方式置于其他角色的装备区。]]
	...
	[":yinli"] = "对手的回合内，其装备牌置入弃牌堆时，你可以获得之。",
					--[[身份局：其他角色的回合内，该角色的装备牌置入弃牌堆时，你可以获得之。]]
	["kofxiaoji"] = "枭姬",
	...
	["&kof_liubei"] = "刘备",
	["renwang"] = "仁望",
	[":renwang"] = "对手于其出牌阶段内对包括你的角色使用第二张及以上【杀】或非延时锦囊牌时，你可以：令其弃置一张牌，否则该牌对你无效。",
					--[[身份局：一名其他角色于其出牌阶段内对包括你的角色使用第二张及以上【杀】或非延时锦囊牌时，你可以：令其弃置一张牌，否则该牌对你无效。]]
	...
	[":shenju"] = "<font color=\"blue\"><b>锁定技。</b></font>你的手牌上限+X。（X为弃牌阶段开始时对手的体力值）",
					--[[身份局：锁定技。你的手牌上限+X。（X为弃牌阶段开始时其他角色最大的体力值）]]

	["kof_huatuo"] = "华佗1v1",
	["&kof_huatuo"] = "华佗",
	["puji"] = "普济",
	[":puji"] = "<font color=\"green\"><b>阶段技。</b></font>若对手有牌，你可以弃置一张牌：若如此做，你弃置其一张牌，然后以此法弃置了♠牌的角色摸一张牌。",
				--[[身份局：阶段技。你可以弃置一张牌并选择一名有牌的其他角色：若如此做，你弃置其一张牌，然后以此法弃置了♠牌的角色摸一张牌。]]
