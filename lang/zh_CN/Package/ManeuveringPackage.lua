...
return {
	...
	["guding_blade"] = "古锭刀",
	[":guding_blade"] = "装备牌·武器<br />攻击范围：２<br />武器特效：锁定技。每当你使用【杀】对目标角色造成伤害时，若该角色没有手牌，此伤害+1",
	["#GudingBladeEffect"] = "%from 的【<font color=\"yellow\"><b>古锭刀</b></font>】效果被触发， %to 没有手牌，伤害从 %arg 增加至 %arg2",

	["vine"] = "藤甲",
	[":vine"] = "装备牌·防具<br />防具效果：锁定技。【南蛮入侵】、【万箭齐发】和普通【杀】对你无效。每当你受到火焰伤害时，此伤害+1",
	["#VineDamage"] = "%from 的防具【<font color=\"yellow\"><b>藤甲</b></font>】效果被触发，火焰伤害由 %arg 点增加至 %arg2 点",

	["silver_lion"] = "白银狮子",
	[":silver_lion"] = "装备牌·防具<br />防具效果：锁定技。每当你受到伤害时，若该伤害多于1点，防止多余的伤害。每当你失去装备区里的【白银狮子】后，你回复1点体力",
	...
	[":supply_shortage"] = "延时锦囊牌<br />出牌时机：出牌阶段<br />使用目标：距离1的一名其他角色。<br />作用效果：将【兵粮寸断】置于目标角色判定区内。目标角色判定阶段进行判定；若结果不为梅花，则跳过其摸牌阶段。然后将【兵粮寸断】置入弃牌堆。",
