...
config = {
	...
	pairs_ban = {
		...
		"zhanghe+yuanshu",
		"dianwei+weiyan",
		"dengai+zhangjiao", "dengai+shensimayi", "dengai+zhugejin", "dengai+nos_simayi", "dengai+nos_zhangjiao",
		...
		"huanggai+sunshangxiang", "huanggai+yuanshao", "huanggai+yanliangwenchou", "huanggai+dongzhuo",
		    ...
		    "huanggai+neo_zhangfei", "huanggai+nos_zhangfei", "huanggai+nos_huangyueying", "huanggai+nos_guanxingzhangbao",
		...
		"guanxingzhangbao+bgm_zhangfei", "guanxingzhangbao+heg_sunce", "guanxingzhangbao+nos_luxun", "guanxingzhangbao+nos_zhangchunhua",
