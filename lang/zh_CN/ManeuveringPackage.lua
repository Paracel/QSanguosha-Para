...
return {
	...
	["analeptic"] = "酒",
	[":analeptic"] = "基本牌<br />出牌时机：1、出牌阶段；2、当自己进入濒死阶段时<br />使用目标：你<br />作用效果：1、令自己本阶段使用的下一张【杀】将要造成的伤害+1（每阶段限一次）；2、回复1点体力",
	["#UnsetDrankEndOfTurn"] = "%from 的出牌阶段结束，【<font color=\"yellow\"><b>酒</b></font>】的效果消失",

	["fan"] = "朱雀羽扇",
	[":fan"] = "装备牌·武器<br />攻击范围：４<br />武器特效：你可以将一张普通【杀】当火【杀】使用",
	["fan:yes"] = "你可以将一张普通【杀】当火【杀】使用",

	["guding_blade"] = "古锭刀",
	[":guding_blade"] = "装备牌·武器<br />攻击范围：２<br />武器特效：<font color=\"blue\"><b>锁定技。</b></font>每当你使用【杀】对目标角色造成伤害时，若该角色没有手牌，此伤害+1",
	["#GudingBladeEffect"] = "%from 的【<font color=\"yellow\"><b>古锭刀</b></font>】特效被触发， %to 没有手牌，伤害从 %arg 增加至 %arg2",
	...
	["silver_lion"] = "白银狮子",
	[":silver_lion"] = "装备牌·防具<br />防具效果：<font color=\"blue\"><b>锁定技。</b></font>没当你受到伤害时，若该伤害多于1点，你防止多余的伤害。每当你失去装备区里的【白银狮子】后，你回复1点体力",
