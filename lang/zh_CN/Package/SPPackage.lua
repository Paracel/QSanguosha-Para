...
return {
	...
	["@jilei_trick"] = "鸡肋（锦囊牌）",
	["danlao"] = "啖酪",
	[":danlao"] = "每当一张锦囊牌指定了包括你在内的至少两名目标后，你可以摸一张牌，然后该锦囊牌对你无效。",
	...
	["yuanhu"] = "援护",
	[":yuanhu"] = "结束阶段开始时，你可以将一张装备牌置于一名角色装备区内：若该牌为武器牌，你弃置该角色距离1的一名角色区域内的一张牌；若该牌为防具牌，该角色摸一张牌；若该牌为坐骑牌，该角色回复1点体力。",
	...
	["bifa"] = "笔伐",
	[":bifa"] = "结束阶段开始时，你可以将一张手牌暗置于一名无“笔伐牌”的其他角色旁：若如此做，该角色的回合开始时，其观看该牌，然后选择一项：1.交给你一张与该牌类型相同的牌并获得该牌；2.将该牌置入弃牌堆，然后失去1点体力。",
	...
	["zhoufu"] = "咒缚",
	[":zhoufu"] = "<font color=\"green\"><b>阶段技。</b></font>你可以将一张手牌置于一名无“咒缚牌”的其他角色旁：若如此做，该角色进行判定时，以“咒缚牌”作为判定牌。一名角色的回合结束后，若该角色有“咒缚牌”，你获得该牌。",
	["incantation"] = "咒缚",
	["yingbing"] = "影兵",
	...
	["qiangwu"] = "枪舞",
	[":qiangwu"] = "<font color=\"green\"><b>阶段技。</b></font>你可以进行判定：若如此做，本回合，你使用点数小于判定牌点数的【杀】无距离限制，你使用点数大于判定牌点数的【杀】无次数限制且不计入次数限制。",

	["#zumao"] = "碧血染赤帻",
	["zumao"] = "祖茂",
	["illustrator:zumao"] = "DH",
	["yinbing"] = "引兵",
	[":yinbing"] = "结束阶段开始时，你可以将任意数量的非基本牌置于武将牌上。每当你受到【杀】或【决斗】的伤害后，你将一张“引兵牌”置入弃牌堆。",
	["@yinbing"] = "你可以发动“引兵”",
	["~yinbing"] = "选择任意数量的非基本牌→点击确定",
	["juedi"] = "绝地",
	...
	["#AocaiUse"] = "%from 发动 %arg 使用/打出了牌堆顶的牌",
