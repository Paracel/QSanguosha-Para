...
return {
	...
	["wuhun"] = "武魂",
	[":wuhun"] = "<font color=\"blue\"><b>锁定技。</b></font>每当你受到伤害扣减体力前，伤害来源获得等于伤害点数的“梦魇”标记。你死亡时，你选择“梦魇”标记数最多且不为0的一名存活角色，该角色进行判定：若结果不为【桃】或【桃园结义】，该角色死亡。",
	...
	["shenlvmeng"] = "神吕蒙",
	["shelie"] = "涉猎",
	[":shelie"] = "摸牌阶段开始时，你可以放弃摸牌并展示牌堆顶的五张牌：若如此做，你获得其中每种花色的牌各一张，然后将其余的牌置入弃牌堆。",
	["gongxin"] = "攻心",
	...
	["shenzhouyu"] = "神周瑜",
	["qinyin"] = "琴音",
	[":qinyin"] = "<font color=\"green\"><b>阶段技。</b></font>每当你于弃牌阶段内因你的弃置而失去两张或更多的手牌后，你可以选择一项：令所有角色各回复1点体力，或令所有角色各失去1点体力。",
	...
	["shenzhugeliang"] = "神诸葛亮",
	["qixing"] = "七星",
	[":qixing"] = "分发起始手牌时，你额外获得七张牌，然后你将其中七张暗置移出游戏，称为“星”。摸牌阶段结束时，你可以将任意数量的手牌与等量的“星”交换。",
	["@star"] = "七星",
	["stars"] = "星",
	["@qixing-exchange"] = "请选择 %arg 张手牌用于交换",
	["kuangfeng"] = "狂风",
	[":kuangfeng"] = "结束阶段开始时，你可以将一张“星”置入弃牌堆并选择一名角色：若如此做，直到你的回合开始时，伤害结算开始时，该角色受到的火焰伤害+1。",
	["@gale"] = "狂风",
	["@kuangfeng-card"] = "你可以发动“狂风”",
	["~kuangfeng"] = "选择一名角色→点击确定→然后在窗口中选择一张牌",
	["dawu"] = "大雾",
	[":dawu"] = "结束阶段开始时，你可以将任意数量的“星”置入弃牌堆并选择等量的角色：若如此做，直到你的回合开始时，伤害结算开始时，防止这些角色受到的非雷电属性的伤害。",
	["@fog"] = "大雾",
	["@dawu-card"] = "你可以发动“大雾”",
	...
	["shenfen"] = "神愤",
	[":shenfen"] = "<font color=\"green\"><b>阶段技。</b></font>你可以弃六枚“暴怒”标记：若如此做，所有其他角色受到你造成的1点伤害，弃置装备区的所有牌，弃置四张手牌，然后你将武将牌翻面。",
	...
	["longhun"] = "龙魂",
	[":longhun"] = "你可以将X张同花色的牌按以下规则使用或打出：<font color=\"red\">♥</font>当【桃】；<font color=\"red\">♦</font>当火【杀】；♠当【无懈可击】；♣当【闪】。（X为你的体力值且至少为1）",
