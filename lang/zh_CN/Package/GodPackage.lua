...
return {
	...
	["shenzhugeliang"] = "神诸葛亮",
	["qixing"] = "七星",
	[":qixing"] = "分发起始手牌时，你可以获得十一张牌：若如此做，你选择其中四张作为手牌，将其余七张移出游戏称为“星”。摸牌阶段结束时，你可以将任意数量的手牌与等数量的“星”交换。",
	["@star"] = "七星",
	["stars"] = "星",
	["@qixing-exchange"] = "请选择 %arg 张手牌用于交换",
	["kuangfeng"] = "狂风",
	[":kuangfeng"] = "结束阶段开始时，你可以将一张“星”置入弃牌堆并选择一名角色：若如此做，你的回合开始前，伤害结算开始时，该角色受到的火焰伤害+1。",
	["@gale"] = "狂风",
	["@kuangfeng-card"] = "你可以发动“狂风”",
	["~kuangfeng"] = "选择一名角色→点击确定→然后在窗口中选择一张牌",
	["dawu"] = "大雾",
	[":dawu"] = "结束阶段开始时，你可以将任意数量的“星”置入弃牌堆并选择等数量的角色：若如此做，你的回合开始前，伤害结算开始时，防止这些角色受到的非雷电属性的伤害。",
	["@fog"] = "大雾",
	["@dawu-card"] = "你可以发动“大雾”",
