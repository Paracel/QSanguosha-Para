...
return {
	...
	["zuixiang"] = "醉乡",
	[":zuixiang"] = "<font color=\"red\"><b>限定技。</b></font>开始阶段开始时，你可以将牌堆顶的三张牌置于你的武将牌上，称为“醉乡牌”，你不能使用或打出“醉乡牌”中存在的类别的牌，且这些类别的牌对你无效。此后每个开始阶段开始时，你重复此流程。若你的武将牌上出现同点数的牌，你获得所有“醉乡牌”，你以此法获得的牌不能发动“漫卷”。",
	["@sleep"] = "醉乡",
	["dream"] = "醉乡",
	...
	["fuluan"] = "扶乱",
	[":fuluan"] = "<font color=\"green\"><b>阶段技。</b></font>若你未于此阶段使用过【杀】，你可以弃置三张相同花色的牌并选择攻击范围内的一名其他角色：若如此做，该角色将武将牌翻面，你不能使用【杀】直到回合结束。",
	["shude"] = "淑德",
	...
	["tuqi"] = "突骑",
	[":tuqi"] = "<font color=\"blue\"><b>锁定技。</b></font>开始阶段开始时，若你的武将牌上有“扈”，你将所有“扈”置入弃牌堆：若以此法置入弃牌堆的“扈”小于或等于两张，你摸一张牌。此回合内，其他角色与你的距离-X。（X为开始阶段开始时置于弃牌堆的“扈”的数量）",
	["retinue"] = "扈",
	["@diyyicong"] = "你可以发动“義從”",
