...
return {
	...
	["&nos_xiahoudun"] = "夏侯惇",
	["nosganglie"] = "刚烈",
	[":nosganglie"] = "每当你受到伤害后，你可以进行判定：若结果不为红桃，则伤害来源选择一项：弃置两张手牌，或受到你造成的1点伤害。",
	...
	["&nos_yuji"] = "于吉",
	["nosguhuo"] = "蛊惑",
	[":nosguhuo"] = "你可以扣置一张手牌当做一张基本牌或非延时锦囊牌使用或打出，体力值大于0的其他角色选择是否质疑，然后你展示该牌：若无角色质疑，该牌按你所述类型结算；若有角色质疑：若该牌为真，质疑角色各失去1点体力；若该牌为假，质疑角色各摸一张牌；且若该牌为红桃且为真，则依旧进行结算，否则将其置入弃牌堆。",
	...
	["nosxuanhuo"] = "眩惑",
	[":nosxuanhuo"] = "阶段技。你可以将一张红桃手牌交给一名其他角色：若如此做，你获得该角色的一张牌，然后将该牌交给除该角色外的另一名角色。",
	...
	["nospower"] = "权",
	["nosbaijiang"] = "拜将",
	[":nosbaijiang"] = "觉醒技。准备阶段开始时，若你的装备区的装备牌大于或等于三张，你增加1点体力上限，回复1点体力，然后失去“权计”和“争功”并获得“野心”（每当你造成或受到伤害后，你可以将牌堆顶的一张牌置于武将牌上，称为“权”。阶段技。你可以获得任意数量的“权”，然后将等量的手牌加入“权”）。",
	["$NosBaijiangAnimate"] = "image=image/animate/nosbaijiang.png",
	["nosyexin"] = "野心",
	[":nosyexin"] = "每当你造成或受到伤害后，你可以将牌堆顶的一张牌置于武将牌上，称为“权”。阶段技。你可以获得任意数量的“权”，然后将等量的手牌加入“权”。",
	["noszili"] = "自立",
	[":noszili"] = "觉醒技。准备阶段开始时，若你的“权”大于或等于四张，你失去1点体力上限，然后获得“排异”（结束阶段开始时，你可以将一张“权”移动至一名角色的手牌、装备区（若该“权”为装备牌）或判定区（若该“权”为延时类锦囊牌）：若该角色不是你，你摸一张牌）。",
