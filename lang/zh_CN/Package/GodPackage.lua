...
return {
	...
	["shenzhugeliang"] = "神诸葛亮",
	["qixing"] = "七星",
	[":qixing"] = "分发起始手牌时，你额外获得七张牌，然后你将其中七张暗置移出游戏，称为“星”。摸牌阶段结束时，你可以将任意数量的手牌与等数量的“星”交换。",
	["@star"] = "七星",
	["stars"] = "星",
	...
	["dawu"] = "大雾",
	[":dawu"] = "结束阶段开始时，你可以将任意数量的“星”置入弃牌堆并选择等数量的角色：若如此做，直到你的回合开始时，伤害结算开始时，防止这些角色受到的非雷电属性的伤害。",
	["@fog"] = "大雾",
	["@dawu-card"] = "你可以发动“大雾”",
