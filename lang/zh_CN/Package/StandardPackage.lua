...
local t = {
	...
	["halberd"] = "方天画戟",
	[":halberd"] = "装备牌·武器<br />攻击范围：４<br />武器特效：<font color=\"blue\"><b>锁定技。</b></font>你使用最后的手牌【杀】可以额外选择至多两个目标。",
	...
	["indulgence"] = "乐不思蜀",
	[":indulgence"] = "延时锦囊牌<br />出牌时机：出牌阶段<br />使用目标：一名其他角色。<br />作用效果：将【乐不思蜀】置于目标角色判定区内。目标角色下个判定阶段进行判定；若结果不为<font color=\"red\">♥</font>，则跳过其出牌阶段。然后将【乐不思蜀】置入弃牌堆。",

	["lightning"] = "闪电",
	[":lightning"] = "延时锦囊牌<br />出牌时机：出牌阶段<br />使用目标：你<br />作用效果：将【闪电】置于你判定区内，目标角色下个判定阶段进行判定；若结果为♠2-9，则该角色受到3点雷电伤害，将闪电置入弃牌堆，否则将【闪电】移动到当前目标角色下家判定区内。",
}
