...
return {
	...
	[":huanshi_p"] = "每当一名角色的判定牌生效前，你可以令该角色观看你的手牌，然后该角色选择你的一张牌，你打出该牌代替之。",
	...
	["&vs_xiahoudun"] = "夏侯惇",
	["vsganglie"] = "刚烈",
	[":vsganglie"] = "每当你受到伤害后，你可以选择一名对方角色并进行判定：若结果不为红桃，则该角色选择一项：弃置两张手牌，或受到你造成的1点伤害。",
	[":vsganglie_p"] = "每当你受到伤害后，你可以选择一名其他角色并进行判定：若结果不为♥，则该角色选择一项：弃置两张手牌，或受到你造成的1点伤害。",
	["vsganglie-invoke"] = "你可以发动“刚烈”<br> <b>操作提示</b>: 选择一名其他角色→点击确定<br/>",

	["vs_guanyu"] = "关羽3v3",
	["&vs_guanyu"] = "关羽",
	["zhongyi"] = "忠义",
	[":zhongyi"] = "限定技。出牌阶段，你可以将一张红色手牌置于武将牌上。若你有“忠义”牌，己方角色使用的【杀】对目标角色造成伤害时，此伤害+1。身份牌重置后，你将“忠义”牌置入弃牌堆。",
	[":zhongyi_p"] = "限定技。出牌阶段，你可以将一张红色手牌置于武将牌上。若你有“忠义”牌，【杀】对目标角色造成伤害时，你可以令此伤害+1。你的下个回合开始时，你将“忠义”牌置入弃牌堆。",
	["loyal"] = "忠义",
	["@loyal"] = "忠义",
	...
	["vscrossbow"] = "连弩",
	[":vscrossbow"] = "装备牌·武器<br />攻击范围：１<br />武器特效：锁定技。出牌阶段，你可以额外使用三张【杀】。",
}
