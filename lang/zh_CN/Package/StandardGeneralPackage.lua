...
return {
	...
	["yiji"] = "遗计",
	[":yiji"] = "每当你受到1点伤害后，你可以摸两张牌，然后你可以分别在至多两名其他角色的武将牌旁扣置一至两张手牌：若如此做，这些角色的下个摸牌阶段开始时，其获得所有“遗计牌”。",
	...
	["rende"] = "仁德",
	[":rende"] = "阶段技。你可以将任意数量的手牌任意分配给其他角色。每当你于本阶段内以此法给出的手牌首次达到两张或更多后，你回复1点体力。",
	["@rende-give"] = "你可以发动“仁德”",
	...
	["jizhi"] = "集智",
	[":jizhi"] = "每当你使用一张锦囊牌时，你可以展示牌堆顶的一张牌：若该牌为基本牌，你选择一项：将之置入弃牌堆，或用一张手牌替换之；若该牌不为基本牌，你获得之。",
	...
	["qianxin"] = "潜心",
	[":qianxin"] = "觉醒技。每当你造成伤害后，若你已受伤，你失去1点体力上限，然后获得“荐言”（阶段技。你可以选择一种牌的类别或颜色，然后你依次亮出牌堆顶的牌直到与你的选择相符，然后你令一名男性角色获得该牌，再将亮出的牌置入弃牌堆）。",
	["jianyan"] = "荐言",
	[":jianyan"] = "阶段技。你可以选择一种牌的类别或颜色，然后你依次亮出牌堆顶的牌直到与你的选择相符，然后你令一名男性角色获得该牌，再将亮出的牌置入弃牌堆。",
	...
	["sunquan"] = "孙权",
	["zhiheng"] = "制衡",
	[":zhiheng"] = "阶段技。你可以弃置任意数量的牌，然后摸等量的牌。",
	["jiuyuan"] = "救援",
	...
	["fanjian"] = "反间",
	[":fanjian"] = "阶段技。你可以选择一种花色并交给一名其他角色一张该花色的手牌，然后该角色选择一项：展示所有手牌并弃置所有该花色的手牌，或失去1点体力。",
	...
	["guose"] = "国色",
	[":guose"] = "阶段技。你可以选择一项：1.将一张方块牌当【乐不思蜀】使用；2.弃置一张方块牌并选择场上的一张【乐不思蜀】：若如此做，你弃置该【乐不思蜀】。然后你摸一张牌。",
	["liuli"] = "流离",
	[":liuli"] = "每当你成为【杀】的目标时，你可以弃置一张牌并选择你攻击范围内的一名其他角色（除该【杀】使用者）：若如此做，该角色成为此【杀】的目标。",
	...
	["tongji"] = "同疾",
	[":tongji"] = "锁定技。若你的手牌数大于你的体力值，且你在一名其他角色的攻击范围内，则其他角色不能被选择为该角色的【杀】的目标。",

	["#st_huaxiong"] = "飞扬跋扈",
	["st_huaxiong"] = "华雄",
	["illustrator:st_huaxiong"] = "地狱许",
	["yaowu"] = "耀武",
	[":yaowu"] = "锁定技。每当你受到红色【杀】造成的伤害时，伤害来源选择一项：回复1点体力，或摸一张牌。",
	...
	["noslonghun"] = "龙魂",
	[":noslonghun"] = "你可以将一张牌按以下规则使用或打出：红桃当【桃】；方块当火【杀】；黑桃当【无懈可击】；梅花当【闪】。准备阶段开始时，若其他角色的装备区内有【青釭剑】，你可以获得之。",
