...
return {
	...
	["qiaobian"] = "巧变",
	[":qiaobian"] = "你可以弃置一张手牌：若如此做，跳过一个阶段（除开始阶段和结束阶段）。若以此法跳过摸牌阶段，你可以依次获得一至两名其他角色的各一张手牌；若以此法跳过出牌阶段，你可以将场上的一张牌置于另一名角色相应的区域内。",
	["@qiaobianask"] = "请选择目标角色",
	...
	["field"] = "田",
	["zaoxian"] = "凿险",
	[":zaoxian"] = "<font color=\"purple\"><b>觉醒技。</b></font>开始阶段开始时，若你的“田”大于或等于三张，你失去1点体力上限，然后获得技能“急袭”（你可以将一张“田”当【顺手牵羊】使用）。",
	...
	["zhiji"] = "志继",
	[":zhiji"] = "<font color=\"purple\"><b>觉醒技。</b></font>开始阶段开始时，若你没有手牌，你失去1点体力上限，然后回复1点体力或摸两张牌，并获得技能“观星”。",
	["zhiji:draw"] = "摸2张牌",
	...
	["fangquan"] = "放权",
	[":fangquan"] = "你可以跳过你的出牌阶段并在结束阶段开始时弃置一张手牌：若如此做，令一名其他角色进行一个额外的回合。",
	["ruoyu"] = "若愚",
	[":ruoyu"] = "<font color=\"orange\"><b>主公技。</b></font><font color=\"purple\"><b>觉醒技。</b></font>开始阶段开始时，若你的体力值为场上最少（或之一），你增加1点体力上限，回复1点体力，然后获得技能“激将”。",
	...
	["hunzi"] = "魂姿",
	[":hunzi"] = "<font color=\"purple\"><b>觉醒技。</b></font>开始阶段开始时，若你的体力值为1，你失去1点体力上限，然后获得技能“英姿”和“英魂”。",
