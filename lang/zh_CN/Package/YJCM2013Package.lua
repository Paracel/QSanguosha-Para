...
return {
	...
	["yuce"] = "御策",
	[":yuce"] = "每当你受到伤害后，你可以展示一张手牌：若如此做，伤害来源须弃置一张与该牌类型不同的手牌，否则你回复1点体力。",
	...
	["qiaoshui"] = "巧说",
	[":qiaoshui"] = "<font color=\"green\"><b>阶段技。</b></font>你可以与一名其他角色拼点：若你赢，本回合你使用的下一张基本牌或非延时类锦囊牌可以增加一个额外目标（无距离限制）或减少一个目标（若原目标数大于1）；若你没赢，你不能使用锦囊牌，直到回合结束。",
	["qiaoshui:add"] = "增加一个目标",
	...
	["xiansi"] = "陷嗣",
	[":xiansi"] = "开始阶段开始时，你可以将一至两名其他角色的各一张牌置于你的武将牌上，称为“逆”。每当一名其他角色需要对你使用【杀】时，该角色可以将两张“逆”置入弃牌堆，视为对你使用一张【杀】。",
	...
	["duodao"] = "夺刀",
	[":duodao"] = "<font color=\"green\"><b>阶段技。</b></font>你可以与一名装备区内有武器牌的其他角色拼点：若你赢，你获得其装备区的武器牌；若你没赢，你不能使用【杀】，直到回合结束。",
	["anjian"] = "暗箭",
	...
	["danshou"] = "胆守",
	[":danshou"] = "每当你造成伤害后，你可以摸一张牌，然后结束一切结算并结束当前回合。",
