...
return {
	...
	["dahe"] = "大喝",
	[":dahe"] = "阶段技。你可以与一名其他角色拼点：若你赢，你可以将该角色的拼点牌交给一名体力值不多于你的角色，本回合该角色使用的非红桃【闪】无效；若你没赢，你展示所有手牌，然后弃置一张手牌。",
	...
	["tanhu"] = "探虎",
	[":tanhu"] = "阶段技。你可以与一名其他角色拼点：若你赢，你无视与该角色的距离，你使用的非延时锦囊牌对该角色结算时不能被【无懈可击】响应，直到回合结束。",
	["mouduan"] = "谋断",
	...
	["zhaolie"] = "昭烈",
	[":zhaolie"] = "摸牌阶段，你可以少摸一张牌并选择你攻击范围内的一名其他角色：若如此做，该角色亮出牌堆顶的三张牌，将其中的非基本牌和【桃】置入弃牌堆，然后选择一项：1.令你对其造成X点伤害，然后该角色获得其余的牌；2.该角色弃置X张牌，然后你获得其余的牌。（X为其中非基本牌的数量）",
	...
	["brocade"] = "锦",
	["junwei"] = "军威",
	[":junwei"] = "结束阶段开始时，你可以将三张“锦”置入弃牌堆并选择一名角色：若如此做，该角色可以展示一张【闪】并将该【闪】交给由你选择的一名角色，否则该角色失去1点体力，你将其装备区的一张牌移出游戏：若如此做，该角色的回合结束后，将这张装备牌移回其装备区（代替原装备）。",
	...
	["fenyong"] = "愤勇",
	[":fenyong"] = "每当你受到伤害后，你可以竖置体力牌。每当你受到伤害时，若你的体力牌处于竖置状态，防止此伤害。",
	["@fenyong"] = "愤勇",
	["xuehen"] = "雪恨",
	[":xuehen"] = "锁定技。一名角色的结束阶段开始时，若你的体力牌处于竖置状态，你横置之，然后选择一项：1.弃置当前回合角色X张牌。 2.视为你使用一张无距离限制的【杀】。（X为你已损失的体力值）",
	...
	["fuluan"] = "扶乱",
	[":fuluan"] = "阶段技。若你未于出牌阶段使用过【杀】，你可以弃置三张相同花色的牌并选择攻击范围内的一名其他角色：若如此做，该角色将武将牌翻面，你不能使用【杀】直到回合结束。",
	["shude"] = "淑德",
	...
	["huangen"] = "皇恩",
	[":huangen"] = "每当至少两名角色成为非延时类锦囊牌的目标后，你可以令其中至多X名角色各摸一张牌，然后该锦囊牌对这些角色无效。（X为你的体力值）",
	["hantong"] = "汉统",
	...
	["tuqi"] = "突骑",
	[":tuqi"] = "锁定技。准备阶段开始时，若你的武将牌上有“扈”，你将所有“扈”置入弃牌堆：若X小于或等于2，你摸一张牌。本回合你与其他角色的距离-X。（X为准备阶段开始时置于弃牌堆的“扈”的数量）",
	["retinue"] = "扈",
	["@diyyicong"] = "你可以发动“義從”",
