...
return {
	...
	["&vs_xiahoudun"] = "夏侯惇",
	["vsganglie"] = "刚烈",
	[":vsganglie"] = "每当你受到伤害后，你可以选择一名对方角色并进行判定：若结果不为<font color=\"red\">♥</font>，则该角色选择一项：弃置两张手牌，或受到你造成的1点伤害。",
					--[[身份局：每当你受到伤害后，你可以选择一名其他角色并进行判定：若结果不为♥，则该角色选择一项：弃置两张手牌，或受到你造成的1点伤害。]]
	...
	["&vs_lvbu"] = "吕布",
	["zhanshen"] = "战神",
	[":zhanshen"] = "<font color=\"purple\"><b>觉醒技。</b></font>准备阶段开始时，若你已受伤且有己方角色已死亡，你失去1点体力上限，弃置装备区的武器牌，然后获得技能“马术”和“神戟”。",
					--[[身份局：觉醒技。一名其他角色死亡时，可以令你获得一枚“战”标记。准备阶段开始时，若你已受伤且拥有“战”标记，你失去1点体力上限，弃置装备区的武器牌，然后获得技能“马术”和“神戟”。]]
