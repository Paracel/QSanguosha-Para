...
return {
	...
	["bifa"] = "笔伐",
	[":bifa"] = "结束阶段开始时，你可以将一张手牌暗置移出游戏并选择一名其他角色：若如此做，该角色的回合开始时，观看该牌，然后可以交给你一张与该牌类型相同的牌并获得该牌，否则将该牌置入弃牌堆，然后失去1点体力。",
	...
	["yanyu"] = "燕语",
	[":yanyu"] = "一名角色的出牌阶段开始时，你可以弃置一张牌：若如此做，本回合的出牌阶段内，一张与该牌类型相同的牌置入弃牌堆时，你可以令一名角色获得之，本回合限三次。",
	["@yanyu-discard"] = "你可以弃置一张牌发动“燕语”",
	["@yanyu-give"] = "你可以令一名角色获得 %arg[%arg2]",
	["xiaode"] = "孝德",
	[":xiaode"] = "每当一名其他角色死亡时，你可以拥有该角色武将牌上的一项技能（除主公技、限定技与觉醒技），且你不能发动“孝德”，直到你的下个回合结束时。",
	...
	["zhoufu"] = "咒缚",
	[":zhoufu"] = "<font color=\"green\"><b>阶段技。</b></font>你可以将一张手牌移出游戏并选择一名无“咒缚牌”的其他角色。拥有“咒缚牌”的角色进行判定时，以“咒缚牌”作为判定牌。一名角色的回合结束后，若该角色有“咒缚牌”，你获得该牌。",
	["incantation"] = "咒缚",
	["yingbing"] = "影兵",
