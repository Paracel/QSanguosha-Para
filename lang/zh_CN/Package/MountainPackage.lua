...
return {
	...
	["qiaobian"] = "巧变",
	[":qiaobian"] = "你可以弃置一张手牌：若如此做，跳过一个阶段（除准备阶段和结束阶段）。若以此法跳过摸牌阶段，你可以依次获得一至两名其他角色的各一张手牌；若以此法跳过出牌阶段，你可以将场上的一张牌置于另一名角色相应的区域内。",
	["@qiaobianask"] = "请选择目标角色",
	...
	["dengai"] = "邓艾",
	["tuntian"] = "屯田",
	[":tuntian"] = "你的回合外，每当你失去一次手牌后，你可以进行一次判定：若判定结果不为<font color=\"red\">♥</font>，将判定牌置于武将牌上，称为“田”。你与其他角色的距离-X。（X为“田”的数量）",
	["#tuntian-dist"] = "屯田",
	["field"] = "田",
	["zaoxian"] = "凿险",
