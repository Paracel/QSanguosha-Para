...
return {
	...
	["zhaolie"] = "昭烈",
	[":zhaolie"] = "摸牌阶段，你可以少摸一张牌并选择你攻击范围内的一名角色：若如此做，该角色亮出牌堆顶的三张牌，将其中的非基本牌和【桃】置入弃牌堆，然后选择一项：1.令你对其造成X点伤害，然后该角色获得其余的牌；2.该角色弃置X张牌，然后你获得其余的牌。（X为其中非基本牌的数量）",
	...
	["fuluan"] = "扶乱",
	[":fuluan"] = "阶段技。若你未于出牌阶段使用过【杀】，你可以弃置三张相同花色的牌并选择攻击范围内的一名角色：若如此做，该角色将武将牌翻面，你不能使用【杀】直到回合结束。",
	["shude"] = "淑德",
