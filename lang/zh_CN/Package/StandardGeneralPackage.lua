...
return {
	...
	["xiahoudun"] = "夏侯惇",
	["ganglie"] = "刚烈",
	[":ganglie"] = "每当你受到伤害后，你可以进行一次判定：若判定结果不为<font color=\"red\">♥</font>，则伤害来源选择一项：弃置两张手牌，或受到你造成的1点伤害。",
	...
	["xuchu"] = "许褚",
	["luoyi"] = "裸衣",
	[":luoyi"] = "摸牌阶段，你可以少摸一张牌：若如此做，你使用【杀】或【决斗】对目标角色造成伤害时，此伤害+1，直到回合结束。",
	...
	["rende"] = "仁德",
	[":rende"] = "<font color=\"green\"><b>阶段技。</b></font>你可以将任意数量的手牌以任意分配方式交给其他角色。当你于本阶段内以此法给出的手牌首次达到两张或更多后，你回复1点体力。",
	["@rende-give"] = "你可以发动“仁德”",
	...
	["jizhi"] = "集智",
	[":jizhi"] = "每当你使用一张非延时类锦囊牌时，你可以展示牌堆顶的一张牌：若该牌为基本牌，你选择一项：将之置入弃牌堆，或将一张手牌置入弃牌堆替换之；若该牌不为基本牌，你获得之。",
