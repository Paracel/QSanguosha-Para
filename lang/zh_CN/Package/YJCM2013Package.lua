...
return {
	...
	["chengxiang"] = "称象",
	[":chengxiang"] = "每当你受到伤害后，你可以亮出牌堆顶的四张牌，然后获得其中至少一张点数之和小于13的牌，并将其余的牌置入弃牌堆。",
	["renxin"] = "仁心",
	...
	["junxing"] = "峻刑",
	[":junxing"] = "阶段技。你可以弃置至少一张手牌并选择一名其他角色：若如此做，该角色须弃置一张与你弃置的牌类型均不同的手牌，否则将武将牌翻面并摸X张牌。（X为你弃置的牌的数量）",
	...
	["mieji"] = "灭计",
	[":mieji"] = "锁定技。你使用黑色非延时锦囊牌的目标数上限至少为二。",
