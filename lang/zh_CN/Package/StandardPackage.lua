...
local t = {
	...
	["double-sword-card"] = "%src 发动了【雌雄双股剑】特效，你须弃置一张手牌，或令 %src 摸一张牌",
	["double_sword:yes"] = "你可以令目标角色选择一项：弃置一张手牌，或令你摸一张牌",
	...
	["#BladeUse"] = "%from 对 %to 发动了【<font color=\"yellow\"><b>青龙偃月刀</b></font>】特效",
	...
	["halberd"] = "方天画戟",
	[":halberd"] = "装备牌·武器<br />攻击范围：４<br />武器特效：每当你使用【杀】时，若此【杀】是你最后的手牌，你可以额外选择至多两个目标。",

	["kylin_bow"] = "麒麟弓",
	[":kylin_bow"] = "装备牌·武器<br />攻击范围：５<br />武器特效：每当你使用【杀】对目标角色造成伤害时，你可以弃置其装备区内的一张坐骑牌。",
	["kylin_bow:yes"] = "弃置对方的一张坐骑牌",
	["kylin_bow:dhorse"] = "+1坐骑",
	["kylin_bow:ohorse"] = "-1坐骑",

	["eight_diagram"] = "八卦阵",
	[":eight_diagram"] = "装备牌·防具<br />防具效果：每当你需要使用或打出一张【闪】时，你可以进行一次判定：若判定结果为红色，视为你使用或打出了一张【闪】。",
	["eight_diagram:yes"] = "进行一次判定：若判定结果为红色，视为你使用或打出了一张【闪】",
