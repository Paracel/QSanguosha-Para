...
return {
	...
	["quhu"] = "驱虎",
	[":quhu"] = "阶段技。你可以与一名体力值大于你的角色拼点：若你赢，该角色对其攻击范围内的另一名由你选择的角色造成1点伤害；若你没赢，该角色对你造成1点伤害。",
	...
	["qiangxi"] = "强袭",
	[":qiangxi"] = "阶段技。你可以失去1点体力或弃置一张武器牌，并选择攻击范围内的一名其他角色：若如此做，你对该角色造成1点伤害。",
	...
	["shuangxiong"] = "双雄",
	[":shuangxiong"] = "摸牌阶段开始时，你可以放弃摸牌并进行判定：若如此做，判定牌生效后你获得之，本回合你可以将与该牌颜色不同的手牌当【决斗】使用。",
