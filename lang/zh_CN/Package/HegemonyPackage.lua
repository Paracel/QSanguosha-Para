...
return {
	...
	["xiaoguo"] = "骁果",
	[":xiaoguo"] = "其他角色的结束阶段开始时，你可以弃置一张基本牌：若如此做，该角色可以弃置一张装备牌，否则受到你造成的1点伤害。";
	...
	["shenzhi"] = "神智",
	[":shenzhi"] = "开始阶段开始时，你可以弃置所有手牌：若你以此法弃置的牌不少于X张，你回复1点体力。（X为你当前的体力值）",

	["#heg_luxun"] = "擎天之柱",
	["heg_luxun"] = "国战陆逊",
	["&heg_luxun"] = "陆逊",
	["duoshi"] = "度势",
	[":duoshi"] = "出牌阶段，你可以弃置一张红色手牌并选择任意数量的其他角色：若如此做，你与这些角色各摸两张牌并弃置两张牌。每阶段限四次。",
	...
	["fenxun"] = "奋迅",
	[":fenxun"] = "<font color=\"green\"><b>阶段技。</b></font>你可以弃置一张牌并选择一名其他角色：若如此做，你拥有以下技能直到回合结束：你无视与该角色的距离。",
	...
	["shuangren"] = "双刃",
	[":shuangren"] = "出牌阶段开始时，你可以与一名其他角色拼点：若你赢，视为你一名其他角色使用一张无距离限制的普通【杀】（此【杀】不计入出牌阶段使用次数限制）；若你没赢，你结束出牌阶段。",
	["@@shuangren"] = "双刃",
