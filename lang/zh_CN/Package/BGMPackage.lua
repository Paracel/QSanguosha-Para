...
return {
	...
	["zuixiang"] = "醉乡",
	[":zuixiang"] = "<font color=\"red\"><b>限定技。</b></font>准备阶段开始时，你可以将牌堆顶的三张牌置于你的武将牌上。此后每个准备阶段开始时，你重复此流程，直到你的武将牌上出现同点数的“醉乡牌”，然后你获得所有“醉乡牌”，你以此法获得的牌不能发动“漫卷”。你不能使用或打出“醉乡牌”中存在的类别的牌，且这些类别的牌对你无效。",
	["@sleep"] = "醉乡",
	["dream"] = "醉乡",
	...
	["shichou"] = "誓仇",
	[":shichou"] = "<font color=\"orange\"><b>主公技。</b></font><font color=\"red\"><b>限定技。</b></font>准备阶段开始时，你可以选择一名其他蜀势力角色并交给其两张牌。每当你受到伤害时，你将此伤害转移给该角色，然后该角色摸X张牌，直到其第一次进入濒死状态时。（X为伤害点数）",
	["@hate"] = "誓仇",
	["@hate_to"] = "誓仇",
	...
	["fenyong"] = "愤勇",
	[":fenyong"] = "每当你受到伤害后，你可以竖置体力牌。每当你受到伤害时，若你的体力牌处于竖置状态，你防止此伤害。",
	["@fenyong"] = "愤勇",
	["xuehen"] = "雪恨",
	...
	["tuqi"] = "突骑",
	[":tuqi"] = "<font color=\"blue\"><b>锁定技。</b></font>准备阶段开始时，若你的武将牌上有“扈”，你将所有“扈”置入弃牌堆：若X小于或等于2，你摸一张牌。此回合内，其他角色与你的距离-X。（X为准备阶段开始时置于弃牌堆的“扈”的数量）",
	["retinue"] = "扈",
	["@diyyicong"] = "你可以发动“義從”",
