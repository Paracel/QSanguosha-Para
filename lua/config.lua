...
config = {
	...
	pairs_ban = {
		...
		"lvmeng+yuanshu",
		"huanggai+sunshangxiang", "huanggai+yuanshao", "huanggai+yanliangwenchou", "huanggai+dongzhuo", "huanggai+wuguotai", "huanggai+guanxingzhangbao", "huanggai+huaxiong", "huanggai+xiahouba", "huanggai+neo_zhangfei",
		...
		"zhangchunhua+guanxingzhangbao", "zhangchunhua+xiahouba", "zhangchunhua+heg_luxun", "zhangchunhua+neo_zhangfei",
