...
return {
	...
	["&dr_zhouyu"] = "周瑜",
	["drjiedao"] = "借刀",
	[":drjiedao"] = "<font color=\"green\"><b>阶段技。</b></font>你可以将一名其他角色的武器牌移动至你的装备区：若如此做，回合结束时将此武器牌移动回该角色装备区。",

	["#dr_lvbu"] = "武的化身",
	["dr_lvbu"] = "龙版吕布",
	["&dr_lvbu"] = "吕布",
	["drwushuang"] = "无双",
	[":drwushuang"] = "<font color=\"blue\"><b>锁定技。</b></font>每当你指定【杀】的目标后，目标角色须连续使用两张【闪】抵消此【杀】。一名角色响应你使用的【南蛮入侵】或【万箭齐发】时，须再弃置一张牌，否则仍受到伤害。",
