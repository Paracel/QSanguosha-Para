...
local t = {
	...
	["amazing_grace"] = "五谷丰登",
	[":amazing_grace"] = "锦囊牌<br />出牌时机：出牌阶段<br />使用目标：所有角色。<br />作用效果：你亮出牌堆顶等于角色数的牌，每名目标角色获得其中一张牌，然后将其余的牌置入弃牌堆。",
	...
	["wooden_ox"] = "木牛流马",
	[":wooden_ox"] = "装备牌·宝物<br />宝物效果：<br />" ..
					"1. <font color=\"green\"><b>阶段技。</b></font>你可以将一张手牌置于【木牛流马】下：若如此做，你可以将【木牛流马】移动至一名其他角色的装备区。<br />" ..
