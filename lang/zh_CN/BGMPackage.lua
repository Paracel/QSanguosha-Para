...
return {
	...
	["@dahe-jink"] = "%src 使用了【杀】，请使用一张【闪】（由于 %dest 的“%arg”效果，你使用的非♥【闪】无效）",
	["dahe:yes"] = "将拼点牌交给一名角色",
	["dahe:no"] = "不发动",	
	...
	["cv:bgm_lvmeng"] = "风叹息",
	["tanhu"] = "探虎",	
	[":tanhu"] = "<font color=\"green\"><b>阶段技。</b></font>出牌阶段，你可以与一名其他角色拼点：若你赢，你拥有以下技能：此回合内，你无视与该角色的距离，你使用的非延时类锦囊对该角色结算时不能被【无懈可击】响应。",
	["mouduan"] = "谋断",
	...
	["mouduan:yes"] = "你可以弃置一张牌：若如此做，（若此时你的手牌数大于2），你将标记翻至“武”朝上", 
	["@wen"] = "文",
	["@wu"] = "武",
	...
	["brocade"] = "锦",
	["junwei"] = "军威",
	[":junwei"] = "回合结束阶段开始时，你可以将三张“锦”置入弃牌堆并选择一名角色：若如此做，该角色选择一项：1.展示一张【闪】，然后你将该【闪】交给一名角色。2.失去1点体力，然后你将其装备区的一张牌移出游戏，该角色的下个回合结束后，将这张装备牌移回其装备区。",
	["junwei_equip"] = "军威",
	["@junwei-show"] = "请展示一张【闪】",
...
--Lines
 ...
 --魏延
	...
	["hantong"] = "汉统",
	[":hantong"] = "弃牌阶段，你可以将你弃置的牌置于武将牌上，称为“诏”。你可以将一张“诏”置入弃牌堆，然后你拥有并发动以下技能之一：“护驾”、“激将”、“救援”、“血裔”，直到当前回合结束。",
	["edict"] = "诏",
