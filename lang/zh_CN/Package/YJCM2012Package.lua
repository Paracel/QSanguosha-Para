...
return {
	...
	["zhenlie"] = "贞烈",
	[":zhenlie"] = "每当其他角色使用【杀】或非延时类锦囊牌指定你为目标后，你可以失去1点体力：若如此做，你弃置该角色的一张牌，该牌对你无效。",
	["miji"] = "秘计",
	...
	["jiefan"] = "解烦",
	[":jiefan"] = "<font color=\"red\"><b>限定技。</b></font>出牌阶段，你可以选择一名角色，然后攻击范围内包含该角色的所有角色须弃置一张武器牌，否则令该角色摸一张牌。",
