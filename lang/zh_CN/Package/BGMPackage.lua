...
return {
	...
	["kuiwei"] = "溃围",
	[":kuiwei"] = "结束阶段开始时，你可以摸X+2张牌：若如此做，将武将牌翻面，且你的下个摸牌阶段开始时，你弃置X张牌。（X为当前场上武器牌的数量）",
	["@kuiwei"] = "溃围",
	["yanzheng"] = "严整",
	...
	["zuixiang"] = "醉乡",
	[":zuixiang"] = "<font color=\"red\"><b>限定技。</b></font>开始阶段开始时，你可以将牌堆顶的三张牌置于你的武将牌上。此后每个开始阶段开始时，你重复此流程，直到你的武将牌上出现同点数的“醉乡牌”，然后你获得所有“醉乡牌”，你以此法获得的牌不能发动“漫卷”。你不能使用或打出“醉乡牌”中存在的类别的牌，且这些类别的牌对你无效。",
	["@sleep"] = "醉乡",
	["dream"] = "醉乡",
	...
	["tanhu"] = "探虎",
	[":tanhu"] = "<font color=\"green\"><b>阶段技。</b></font>你可以与一名其他角色拼点：若你赢，你拥有以下技能：你无视与该角色的距离，你使用的非延时类锦囊牌对该角色结算时不能被【无懈可击】响应，直到回合结束。",
	["mouduan"] = "谋断",
	...
	["zhaolie_obtain:obtain"] = "你可以获得“昭烈”牌，否则 %src 获得这些牌",
	["@zhaolie-discard"] = "你可以弃置 %arg 张牌令 %src 获得“昭烈”牌，否则你受到 %arg 点伤害并获得这些牌",
	["zhaolie-invoke"] = "你可以发动“昭烈”<br> <b>操作提示</b>: 选择攻击范围内的一名其他角色→点击确定<br/>",
	["shichou"] = "誓仇",
	[":shichou"] = "<font color=\"orange\"><b>主公技。</b></font><font color=\"red\"><b>限定技。</b></font>开始阶段开始时，你可以选择一名其他蜀势力角色并交给其两张牌。每当你受到伤害时，你将此伤害转移给该角色，然后该角色摸X张牌，直到其第一次进入濒死状态时。（X为伤害点数）",
	["@hate"] = "誓仇",
	["@hate_to"] = "誓仇",
	...
	["brocade"] = "锦",
	["junwei"] = "军威",
	[":junwei"] = "结束阶段开始时，你可以将三张“锦”置入弃牌堆并选择一名角色：若如此做，该角色可以展示一张【闪】并将该【闪】交给由你选择的一名角色，否则失去1点体力，然后你将其装备区的一张牌移出游戏，该角色的下个回合结束后，将这张装备牌移回其装备区。",
	...
	["fenyong"] = "愤勇",
	[":fenyong"] = "每当你受到一次伤害后，你可以竖置体力牌。每当你受到伤害时，若你的体力牌处于竖置状态，你防止此伤害。",
	["@fenyong"] = "愤勇",
	["xuehen"] = "雪恨",
	[":xuehen"] = "<font color=\"blue\"><b>锁定技。</b></font>一名角色的结束阶段开始时，若你的体力牌处于竖置状态，你横置之，然后选择一项：1.弃置当前回合角色X张牌。 2.视为你使用一张无距离限制的普通【杀】。（X为你已损失的体力值）",
	...
	["langgu"] = "狼顾",
	[":langgu"] = "每当你受到1点伤害后，你可以进行一次判定且你可以打出一张手牌代替此判定牌：若如此做，你观看伤害来源的所有手牌，然后弃置其中任意数量的与判定牌花色相同的牌。",
	...
	["fuluan"] = "扶乱",
	[":fuluan"] = "<font color=\"green\"><b>阶段技。</b></font>若你未于出牌阶段使用过【杀】，你可以弃置三张相同花色的牌并选择攻击范围内的一名其他角色：若如此做，该角色将武将牌翻面，你不能使用【杀】直到回合结束。",
	["shude"] = "淑德",
	...
	["tuqi"] = "突骑",
	[":tuqi"] = "<font color=\"blue\"><b>锁定技。</b></font>开始阶段开始时，若你的武将牌上有“扈”，你将所有“扈”置入弃牌堆：若X小于或等于2，你摸一张牌。此回合内，其他角色与你的距离-X。（X为开始阶段开始时置于弃牌堆的“扈”的数量）",
	["retinue"] = "扈",
	["@diyyicong"] = "你可以发动“義從”",
