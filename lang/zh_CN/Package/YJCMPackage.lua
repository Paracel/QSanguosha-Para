...
return {
	...
	["xuanhuo"] = "眩惑",
	[":xuanhuo"] = "摸牌阶段开始时，你可以放弃摸牌并选择一名其他角色：若如此做，该角色摸两张牌，然后该角色可以对其攻击范围内由你选择的另一名角色使用一张【杀】，否则令你获得其两张牌。",
	...
	["xuanfeng"] = "旋风",
	[":xuanfeng"] = "每当你失去一次装备区的牌后，或于弃牌阶段内因你的弃置而失去两张或更多的手牌后（弃牌阶段限一次），你可以弃置一名其他角色的一张牌，然后弃置一名其他角色的一张牌。",
	...
	["ganlu"] = "甘露",
	[":ganlu"] = "<font color=\"green\"><b>阶段技。</b></font>你可以令装备区的牌数量差不超过你已损失体力值的两名角色交换他们装备区的装备牌。",
	["buyi"] = "补益",
	...
	["xianzhen"] = "陷阵",
	[":xianzhen"] = "<font color=\"green\"><b>阶段技。</b></font>你可以与一名其他角色拼点：若你赢，本回合，该角色的防具无效，你无视与该角色的距离，你对该角色使用【杀】无次数限制；若你没赢，你不能使用【杀】，直到回合结束。",
	["jinjiu"] = "禁酒",
	...
	["mingce"] = "明策",
	[":mingce"] = "<font color=\"green\"><b>阶段技。</b></font>你可以将一张装备牌或【杀】交给一名其他角色：若如此做，该角色可以视为对其攻击范围内由你选择的另一名角色使用一张【杀】，否则其摸一张牌。",
	["zhichi"] = "智迟",
	...
	["zili"] = "自立",
	[":zili"] = "<font color=\"purple\"><b>觉醒技。</b></font>准备阶段开始时，若“权”大于或等于三张，你失去1点体力上限，摸两张牌或回复1点体力，然后获得“排异”（<font color=\"green\"><b>阶段技。</b></font>你可以将一张“权”置入弃牌堆并选择一名角色：若如此做，该角色摸两张牌。若该角色手牌多于你，你对其造成1点伤害）。",
	...
	["paiyi"] = "排异",
	[":paiyi"] = "<font color=\"green\"><b>阶段技。</b></font>你可以将一张“权”置入弃牌堆并选择一名角色：若如此做，该角色摸两张牌。若该角色手牌多于你，你对其造成1点伤害。",
}
