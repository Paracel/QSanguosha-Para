...
return {
	...
	["&kof_huatuo"] = "华佗",
	["puji"] = "普济",
	[":puji"] = "阶段技。若对手有牌，你可以弃置一张牌：若如此做，你弃置其一张牌，然后以此法弃置黑桃牌的角色摸一张牌。",
	[":puji_p"] = "阶段技。你可以弃置一张牌并选择一名有牌的其他角色：若如此做，你弃置其一张牌，然后以此法弃置黑桃牌的角色摸一张牌。",
	...
	["cuorui"] = "挫锐",
	[":cuorui"] = "锁定技。你的起始手牌数量为X+2张。你跳过你的第一个判定阶段。（X为你的备选武将数）",
	[":cuorui_p"] = "锁定技。分发起始手牌时，你额外获得三张牌。你跳过你的第一个判定阶段。",
	["liewei"] = "裂围",
