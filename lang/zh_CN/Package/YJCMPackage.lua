...
return {
	...
	["zili"] = "自立",
	[":zili"] = "<font color=\"purple\"><b>觉醒技。</b></font>准备阶段开始时，若“权”大于或等于三张，你失去1点体力上限，摸两张牌或回复1点体力，然后获得“排异”（<font color=\"green\"><b>阶段技。</b></font>你可以将一张“权”置入弃牌堆并选择一名角色：若如此做，该角色摸两张牌。若该角色手牌数大于你的手牌数，你对其造成1点伤害）。",
