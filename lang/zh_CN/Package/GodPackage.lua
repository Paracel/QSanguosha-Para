...
return {
	...
	["wuhun"] = "武魂",
	[":wuhun"] = "锁定技。每当你受到伤害扣减体力前，伤害来源获得等于伤害点数的“梦魇”标记。你死亡时，你选择“梦魇”标记数最多且不为0的一名存活角色，该角色进行判定：若结果不为【桃】或【桃园结义】，该角色死亡。",
	...
	["gongxin"] = "攻心",
	[":gongxin"] = "阶段技。你可以观看一名其他角色的手牌，然后选择其中一张红桃牌并选择一项：弃置之，或将其置于牌堆顶。",
	["gongxin:discard"] = "弃置",
	["gongxin:put"] = "置于牌堆顶",
	...
	["yeyan"] = "业炎",
	[":yeyan"] = "限定技。出牌阶段，你可以对至多三名角色各造成1点火焰伤害；你可以弃置四种花色的手牌各一张，失去3点体力并选择一至两名角色：若如此做，你对这些角色造成共计不超过3点火焰伤害且对其中一名角色造成至少2点火焰伤害。",
	["greatyeyan"] = "业炎",
	["smallyeyan"] = "业炎",
	...
	["shenfen"] = "神愤",
	[":shenfen"] = "阶段技。你可以弃六枚“暴怒”标记：若如此做，所有其他角色受到你造成的1点伤害，弃置装备区的所有牌，弃置四张手牌，然后你将武将牌翻面。",
