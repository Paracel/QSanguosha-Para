...
return {
	...
	["kuangfeng"] = "狂风",
	[":kuangfeng"] = "结束阶段开始时，你可以将一张“星”置入弃牌堆并选择一名角色：若如此做，伤害结算开始时，该角色受到的火焰伤害+1，直到你下回合开始。",
	["@gale"] = "狂风",
	["@kuangfeng-card"] = "你可以发动“狂风”",
	["~kuangfeng"] = "选择一名角色→点击确定→然后在窗口中选择一张牌",
	["dawu"] = "大雾",
	[":dawu"] = "结束阶段开始时，你可以将任意数量的“星”置入弃牌堆并选择等数量的角色：若如此做，伤害结算开始时，这些角色受到的除雷电伤害外的伤害被防止，直到你下回合开始。",
	["@fog"] = "大雾",
	["@dawu-card"] = "你可以发动“大雾”",
	...
	["@bear"] = "忍",
	["baiyin"] = "拜印",
	[":baiyin"] ="<font color=\"purple\"><b>觉醒技。</b></font>开始阶段开始时，若你拥有四枚或更多的“忍”，你失去1点体力上限，然后获得技能“极略”（你可以弃一枚“忍”并发动以下技能之一：“鬼才”、“放逐”、“集智”、“制衡”、“完杀”）。",
	...
	["jilve_fangzhu"] = "极略（放逐）",
	["lianpo"] = "连破",
	[":lianpo"] = "一名角色的回合结束后，若你于此回合内杀死至少一名角色，你可以进行一个额外的回合。",
