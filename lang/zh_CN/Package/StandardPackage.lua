...
local t = {
	...
	["crossbow"] = "诸葛连弩",
	[":crossbow"] = "装备牌·武器<br />攻击范围：１<br />武器特效：<font color=\"blue\"><b>锁定技。</b></font>你于出牌阶段内使用【杀】无次数限制。",

	["double_sword"] = "雌雄双股剑",
	[":double_sword"] = "装备牌·武器<br />攻击范围：２<br />武器特效：每当你使用【杀】指定一名异性角色为目标后，你可以令其选择一项：弃置一张手牌，或令你摸一张牌。",
	["double-sword-card"] = "%src 发动了【雌雄双股剑】效果，你须弃置一张手牌，或令 %src 摸一张牌",

	["qinggang_sword"] = "青釭剑",
	[":qinggang_sword"] = "装备牌·武器<br />攻击范围：２<br />武器特效：<font color=\"blue\"><b>锁定技。</b></font>每当你使用【杀】指定一名角色为目标后，你无视其防具，直到此【杀】被【闪】抵消后或造成伤害扣减体力前。",
	...
	["halberd"] = "方天画戟",
	[":halberd"] = "装备牌·武器<br />攻击范围：４<br />武器特效：<font color=\"blue\"><b>锁定技。</b></font>你使用最后的手牌【杀】可以额外选择至多两名目标。",

	["kylin_bow"] = "麒麟弓",
	[":kylin_bow"] = "装备牌·武器<br />攻击范围：５<br />武器特效：每当你使用【杀】对目标角色造成伤害时，你可以弃置其装备区内的一张坐骑牌。",
	["kylin_bow:dhorse"] = "+1坐骑",
	["kylin_bow:ohorse"] = "-1坐骑",

	["eight_diagram"] = "八卦阵",
	[":eight_diagram"] = "装备牌·防具<br />防具效果：每当你需要使用或打出一张【闪】时，你可以进行判定：若结果为红色，视为你使用或打出了一张【闪】。",

	["standard_ex_cards"] = "标准版EX",

	["renwang_shield"] = "仁王盾",
	[":renwang_shield"] = "装备牌·防具<br />防具效果：<font color=\"blue\"><b>锁定技。</b></font>黑色【杀】对你无效",

	["ice_sword"] = "寒冰剑",
	[":ice_sword"] = "装备牌·武器<br />攻击范围：２<br />武器特效：每当你使用【杀】对目标角色造成伤害时，若该角色有牌，你可以防止此伤害，然后依次弃置其两张牌。",
	...
	["snatch"] = "顺手牵羊",
	[":snatch"] = "锦囊牌<br />出牌时机：出牌阶段<br />使用目标：距离1的一名角色<br />作用效果：你获得其区域内的一张牌",

	["dismantlement"] = "过河拆桥",
	[":dismantlement"] = "锦囊牌<br />出牌时机：出牌阶段<br />使用目标：一名其他角色。<br />作用效果：你弃置其区域内的一张牌",

	["nullification"] = "无懈可击",
	[":nullification"] = "锦囊牌<br />出牌时机：目标锦囊对目标角色生效前<br />使用目标：目标锦囊。<br />作用效果：抵消目标锦囊牌对一名角色产生的效果，或抵消另一张【无懈可击】产生的效果。",

	["indulgence"] = "乐不思蜀",
	[":indulgence"] = "延时锦囊牌<br />出牌时机：出牌阶段<br />使用目标：一名其他角色。<br />作用效果：将【乐不思蜀】置于目标角色判定区内。目标角色判定阶段进行判定；若结果不为<font color=\"red\">♥</font>，则跳过其出牌阶段。然后将【乐不思蜀】置入弃牌堆。",

	["lightning"] = "闪电",
	[":lightning"] = "延时锦囊牌<br />出牌时机：出牌阶段<br />使用目标：你<br />作用效果：将【闪电】置于你判定区内，目标角色判定阶段进行判定；若结果为♠2-9，则该角色受到3点雷电伤害，将闪电置入弃牌堆，否则将【闪电】移动到该角色下家判定区内。",
}
