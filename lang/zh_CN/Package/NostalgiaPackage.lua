...
return {
	...
	["moon_spear"] = "银月枪X",
	[":moon_spear"] = "装备牌·武器<br />攻击范围：３<br />武器特效：你的回合外，每当你使用或打出了一张黑色手牌时，你可以对你攻击范围内的一名角色使用一张【杀】",
	["@moon-spear-slash"] = "【银月枪】特效被触发，请使用一张【杀】",
	...
	["@quanji-pindian"] = "你可以发动“权计”",
	["~nosquanji"] = "选择一张手牌→点击确定",
	["nospower"] = "权",
	["nosbaijiang"] = "拜将",
