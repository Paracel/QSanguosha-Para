...
local t = {
	...
	["crossbow"] = "诸葛连弩",
	[":crossbow"] = "装备牌·武器<br />攻击范围：１<br />武器特效：锁定技。你于出牌阶段内使用【杀】无次数限制。",
	...
	["qinggang_sword"] = "青釭剑",
	[":qinggang_sword"] = "装备牌·武器<br />攻击范围：２<br />武器特效：锁定技。每当你指定【杀】的目标后，你无视其防具，直到此【杀】被【闪】抵消后或造成伤害扣减体力前。",
	...
	["halberd"] = "方天画戟",
	[":halberd"] = "装备牌·武器<br />攻击范围：４<br />武器特效：锁定技。你使用最后的手牌【杀】可以额外选择至多两名目标。",
	...
	["renwang_shield"] = "仁王盾",
	[":renwang_shield"] = "装备牌·防具<br />防具效果：锁定技。黑色【杀】对你无效",
	...
	["indulgence"] = "乐不思蜀",
	[":indulgence"] = "延时锦囊牌<br />出牌时机：出牌阶段<br />使用目标：一名其他角色。<br />作用效果：将【乐不思蜀】置于目标角色判定区内。目标角色判定阶段进行判定；若结果不为红桃，则跳过其出牌阶段。然后将【乐不思蜀】置入弃牌堆。",

	["lightning"] = "闪电",
	[":lightning"] = "延时锦囊牌<br />出牌时机：出牌阶段<br />使用目标：你<br />作用效果：将【闪电】置于你判定区内，目标角色判定阶段进行判定；若结果为黑桃2-9，则该角色受到3点雷电伤害，将闪电置入弃牌堆，否则将【闪电】移动到该角色下家判定区内。",
