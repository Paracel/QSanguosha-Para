...
return {
	...
	["&nos_zhoutai"] = "周泰",
	["nosbuqu"] = "不屈",
	[":nosbuqu"] = "每当你扣减体力后，若你的体力为0或更低，你可以将牌堆顶的一张牌置于你的武将牌上。当且仅当出现同点数的“不屈牌”，你进入濒死状态。若你的武将牌上有“不屈牌”，你的体力值为-X+1。（X为“不屈牌”的数量）",
	...
	["&nos_yuji"] = "于吉",
	["nosguhuo"] = "蛊惑",
	[":nosguhuo"] = "每当你需要使用或打出一张基本牌或非延时类锦囊牌时，你可以将一张手牌背面朝上置于桌上，体力值大于0的其他角色选择是否质疑，然后你展示该牌：若无角色质疑，该牌按你所述类型结算；若有角色质疑：若该牌为真，质疑角色各失去1点体力；若该牌为假，质疑角色各摸一张牌；且若该牌为<font color=\"red\">♥</font>且为真，则依旧进行结算，否则将其置入弃牌堆。",
	["question"] = "质疑",
	["noquestion"] = "不质疑",
	...
	["nosxuanfeng"] = "旋风",
	[":nosxuanfeng"] = "每当你失去一次装备区里的牌后，你可以选择一项：视为使用一张无距离限制的【杀】，或对距离1的一名角色造成1点伤害",
